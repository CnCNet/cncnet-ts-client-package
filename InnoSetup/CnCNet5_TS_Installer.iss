...
#define AppName = "CnCNet Tiberian Sun"
...
GameNotFound=Tiberian Sun not found in %1 %nPlease select the right folder...%nNote: You need to have the game installed, Red Alert 2 is not freeware and therefore not included in this installer!
CheckFile=tibsun.mix
GameRegEng=SOFTWARE\Westwood\Tiberian Sun
DefaultGamePathEng=C:\Westwood\SUN\
TFDDirEnglish=EA Games\Command & Conquer The First Decade\Command & Conquer Tiberian Sun(tm)\SUN
TFDDirGerman=EA Games\Command & Conquer Die ersten 10 Jahre\Command & Conquer Tiberian Sun(tm)\SUN
OriginDir=Origin Games\Command and Conquer Tiberian Sun
TFDReg=Software\Electronic Arts\EA Games\Command and Conquer The First Decade
OriginReg=Software\EA Games\Command and Conquer Tiberian Sun
...
AllowNoIcons=yes
OutputBaseFilename=CnCNet5_TS_Installer
...
LicenseFile=Resources\License-TiberianSun.txt
...
[Files]
Source: ..\*; DestDir: "{app}"; Excludes: "SUN.ini,version_u,version,game.exe,DtaverWriter.exe,.gitattributes,.gitignore,.github,README.md,versionconfig.ini,preupdateexec,updateexec,DEPLOYMENTS.md,gitversion.json,GitVersion.yml,update_mpmaps.bat,VersionWriter.exe,VersionWriter-CopiedFiles,InnoSetup,updater-scripts,YRMapsUpdater,DEPLOYMENDS.md"; Flags: ignoreversion
; explicitly list "version" file so that an error is thrown if it does not exist
Source: ..\version; DestDir: "{app}";
; explicitly list "game.exe" file so that an error is thrown if it does not exist
...
Source: Resources\SUN.lcf; DestDir: "{app}"; Flags: ignoreversion uninsneveruninstall
...
[Icons]
Name: "{commondesktop}\Tiberian Sun CnCNet"; Filename: "{app}\TiberianSun.exe"; Check: not RunsOnWine
...
Filename: "{app}\TiberianSun.exe"; WorkingDir: "{app}"; Description: "{cm:LaunchProgram,Tiberian Sun}"; Flags: nowait postinstall runascurrentuser skipifsilent
 
[INI]
Filename: "{app}\SUN.ini"; Section: "Video"; Key: "UseGraphicsPatch"; String: "Yes"; MinVersion: 6.2
Filename: "{app}\SUN.ini"; Section: "Options"; Key: "Win8Compat"; String: "Yes"; MinVersion: 6.2

Filename: "{app}\SUN.INI"; Section: "Video"; Key: "AllowHiResModes"; String: "Yes"
Filename: "{app}\SUN.INI"; Section: "Video"; Key: "ScreenWidth"; String: "800"; Flags: createkeyifdoesntexist
Filename: "{app}\SUN.INI"; Section: "Video"; Key: "ScreenHeight"; String: "600"; Flags: createkeyifdoesntexist
...
Root: HKCU; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueName: {app}\SUN.exe; Flags: deletevalue 
Root: HKLM; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueName: {app}\SUN.exe; Flags: deletevalue
Root: HKCU64; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueName: {app}\SUN.exe; Flags: deletevalue; Check: IsWin64
Root: HKLM64; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueName: {app}\SUN.exe; Flags: deletevalue; Check: IsWin64


Root: HKLM; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueType: String; ValueName: {app}\game.exe; ValueData: "16BITCOLOR 8And16BitTimedPriSync HIGHDPIAWARE"
Root: HKCU; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueType: String; ValueName: {app}\game.exe; ValueData: "16BITCOLOR 8And16BitTimedPriSync HIGHDPIAWARE"
Root: HKCU64; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueType: String; ValueName: {app}\game.exe; ValueData: "16BITCOLOR 8And16BitTimedPriSync HIGHDPIAWARE"; Check: IsWin64
Root: HKLM64; Subkey: Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers; ValueType: String; ValueName: {app}\game.exe; ValueData: "16BITCOLOR 8And16BitTimedPriSync HIGHDPIAWARE"; Check: IsWin64
